        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3 overflow-x-auto no-scrollbar">
            {PRODUCT_IMAGES.map((img, idx) => (
              <button key={idx} onClick={() => setActiveImage(idx)} className={`w-20 aspect-square rounded-xl border-2 flex-shrink-0 transition-all ${activeImage === idx ? 'border-[#6B21A8] scale-105 shadow-md' : 'border-gray-100 opacity-70'}`}>
